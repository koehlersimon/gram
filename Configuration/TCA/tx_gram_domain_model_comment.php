...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:gram/Resources/Private/Language/locallang_db.xlf:tx_gram_domain_model_comment',
        'label' => 'content',
        'label_alt' => 'likes',
        'label_alt_force' => '1',
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_gram_domain_model_comment',
                'foreign_table_where' => 'AND tx_gram_domain_model_comment.pid=###CURRENT_PID### AND tx_gram_domain_model_comment.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'post' => [
            ...
            'config' => [
                'type' => 'group',
                'internal_type' => 'db',
                'allowed' => 'tx_gram_domain_model_post',
                'maxitems' => 1,
                'default' => 0,
                  'suggestOptions' => [
                     'default' => [
